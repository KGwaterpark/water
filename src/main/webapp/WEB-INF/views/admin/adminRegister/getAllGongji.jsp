    ...
    <table class="table-fill">
        ...
        <tbody class="table-hover">
           ...
           <form action="deleteGongji.do?g_id=${gongji.g_id}" method="post">
                    <td class="admintd"><a href="gongjiGet.do?g_id=${gongji.g_id}">${gongji.g_id}</a></td>
                    <td class="admintd"><a href="gongjiGet.do?g_id=${gongji.g_id}">${gongji.g_date}</a></td>
                    <td class="admintd"><a href="gongjiGet.do?g_id=${gongji.g_id}">${gongji.g_title}</a></td>
                    <td class="admintd"><a href="gongjiGet.do?g_id=${gongji.g_id}">${gongji.g_content}</a></td>
