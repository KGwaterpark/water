...
<script>
    function allpack() {
    	...
    	window.close();
    	opener.location.href='allpack.do'; 
    }
    ...
    <div class="popup_wrap">
        <div class="popup_inner">
            <div class="popup_layer">
                <div class="text_area">
                    <strong class="title"><h2>프리미엄 패키지</h2></strong>
                    <p class="text">
<h5>
리조트 : 펜트하우스 객실<br>
워터파크 : 실내 락커 이용<br>
카바나 : 프리미엄 카바나 제공<br></h5>
<h6><font color="#DC143C">*패키지 상품은 구성을 추가 또는 변경 하실 수 없습니다*</font></h6>
                </div>
                <div class="btn_area">
                    <button type="submit" name="button" class="btn" onclick="allpack()">예약</button>
