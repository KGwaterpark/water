...
<%
	...
	int oriprice = 0;
	if(p_type.equals("패밀리 스탠다드")){
		oriprice =200000;
	}else if(p_type.equals("패밀리 프리미엄")){
		oriprice = 250000;
	}else if(p_type.equals("스위트 스탠다드")){
		oriprice = 400000;
	}else if(p_type.equals("스위트 프리미엄")){
		oriprice = 450000;
	}
	...
	<div class="wrap">
		<form action="payimsi.do" method="post">
			...
			<table>
				<tr>
					<td class="th">상품명</td>
					<td class="product">온라인 회원 [NEW 숙박] <%=p_type %> </td>
				</tr>
				<tr>
					<td class="th">이용자명</td>
