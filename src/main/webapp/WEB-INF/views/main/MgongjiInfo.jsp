...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/css/header_style.css" />
		...
		<table border="2" class="table-fill2">
			<thead class="adminth">
				<tr>
					...
					<th class="jm1" width=600>제목</th>
					<th class="admintd11" width=100><input type="button"
						value="뒤로가기" onclick="history.back()" class="mainback1" id="adbtn"></th>
				</tr>
			</thead>
			<tbody>
			...
			<tr>
				<td colspan="3"><textarea name="g_content" id="gongarea"
						rows="5" cols="70" readonly>${gongjiVO.g_content }</textarea></td>
			</tbody>
		</table>
