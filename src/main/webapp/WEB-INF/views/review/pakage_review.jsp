...
<section>
    ...
    <c:forEach var="pakage" items="${revlist}">
    
        <c:set var="sumScores" value="${sumScores + pakage.rev_score}" />
        ...
        <div class="info">
            <div>
                ${pakage.m_id}
                <script>
                    document.write(convertToStars(${pakage.rev_score}));
                </script>
                ${pakage.rev_date}
            </div>

            <div>
                <a>${pakage.rev_contents}</a>
            </div>
        </div>
    </c:forEach>
