...
<section>
    ...
    <form id="reviewForm" action="updaterevinfo.do" method="post">
        <div class="info">
            <div class="reviewView-line">
                ...
                <div class="button-group">
                    <button onclick="formSubmit();" class="btn-tazone">리뷰수정</button>
                </div>
    ...
    <div>    
                    <button onclick="forSubmitdelete();" class="btn-tazone">리뷰삭제</button>
                </div>
</section>
...
<script>
    function forSubmitdelete() {
        ...
        var url = "deleteRevinfo.do?rev_id=" + encodedRevId;
        window.location.href = url;
    }

    function formSubmit(){
        $("#reviewForm").attr("action", "rev_getinfo.do");
        $("#reviewForm").submit();
    }
</script>
</body>
